...
import VendorNotLoggedinIndex from '@/components/VendorNotLoggedinIndex';
      ...
      >
        {
          isLogin ? (
            ...
            <VendorNotLoggedinIndex setShowLoginModal={setShowLoginModal} setShowSignupModal={setShowSignupModal} />
          )
        }
