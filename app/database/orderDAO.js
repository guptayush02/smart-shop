...
const orderDao = {
  ...
  async findAllNearestOrdersForDeliveryPartner(whereClause, distanceLimitKm, lat, long) {
    const rawQuery = `
        SELECT 
        -- Orders
        o.id AS orderId,
      ...
      LEFT JOIN Profiles vendorProfile ON vendorProfile.userId = vr.vendorId AND vendorProfile.defaultAddress = TRUE
